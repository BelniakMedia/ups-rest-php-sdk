...
class XAVResponseCandidateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ShipStream\Ups\Api\Model\XAVResponseCandidate::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ShipStream\Ups\Api\Model\XAVResponseCandidate::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('AddressClassification', $data) && $data['AddressClassification'] !== null) {
            $object->setAddressClassification($this->denormalizer->denormalize($data['AddressClassification'], \ShipStream\Ups\Api\Model\CandidateAddressClassification::class, 'json', $context));
        ...
        if (\array_key_exists('AddressKeyFormat', $data)) {
            ...
            foreach ($data['AddressKeyFormat'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \ShipStream\Ups\Api\Model\CandidateAddressKeyFormat::class, 'json', $context);
            }
    ...
    {
        return [\ShipStream\Ups\Api\Model\XAVResponseCandidate::class => false];
    }
}